...
{
    //computes the difference between current value and user entered value
    class Subtract : Module
    {
        ...
        public override void compute()
        {
            ...
            if (InputBox(currentVal, "Enter a value:", ref str) == DialogResult.OK)
            {
                ...
                double difference = (currentVal - input);
                //Debug.WriteLine("Difference = " + difference);
                setCurrentValue(difference);
            }
        }


        //Dialog box for accepted user input
